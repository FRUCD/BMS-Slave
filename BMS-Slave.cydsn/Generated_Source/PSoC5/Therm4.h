...
void    Therm4_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Therm4_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Therm4__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Therm4_SetInterruptMode() function.
     *  @{
     */
        #define Therm4_INTR_NONE      (uint16)(0x0000u)
        #define Therm4_INTR_RISING    (uint16)(0x0001u)
        #define Therm4_INTR_FALLING   (uint16)(0x0002u)
        #define Therm4_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Therm4_INTR_MASK      (0x01u) 
#endif /* (Therm4__INTSTAT) */
...
/* SIO registers */
#if defined(Therm4__SIO_CFG)
    #define Therm4_SIO_HYST_EN        (* (reg8 *) Therm4__SIO_HYST_EN)
    #define Therm4_SIO_REG_HIFREQ     (* (reg8 *) Therm4__SIO_REG_HIFREQ)
    #define Therm4_SIO_CFG            (* (reg8 *) Therm4__SIO_CFG)
    #define Therm4_SIO_DIFF           (* (reg8 *) Therm4__SIO_DIFF)
#endif /* (Therm4__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Therm4_0_INTTYPE_REG 		(* (reg8 *) Therm4__0__INTTYPE)
#endif /* (Therm4__INTSTAT) */
