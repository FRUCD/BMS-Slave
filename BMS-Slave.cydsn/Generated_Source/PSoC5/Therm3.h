...
void    Therm3_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Therm3_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Therm3__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Therm3_SetInterruptMode() function.
     *  @{
     */
        #define Therm3_INTR_NONE      (uint16)(0x0000u)
        #define Therm3_INTR_RISING    (uint16)(0x0001u)
        #define Therm3_INTR_FALLING   (uint16)(0x0002u)
        #define Therm3_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Therm3_INTR_MASK      (0x01u) 
#endif /* (Therm3__INTSTAT) */
...
/* SIO registers */
#if defined(Therm3__SIO_CFG)
    #define Therm3_SIO_HYST_EN        (* (reg8 *) Therm3__SIO_HYST_EN)
    #define Therm3_SIO_REG_HIFREQ     (* (reg8 *) Therm3__SIO_REG_HIFREQ)
    #define Therm3_SIO_CFG            (* (reg8 *) Therm3__SIO_CFG)
    #define Therm3_SIO_DIFF           (* (reg8 *) Therm3__SIO_DIFF)
#endif /* (Therm3__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Therm3_0_INTTYPE_REG 		(* (reg8 *) Therm3__0__INTTYPE)
#endif /* (Therm3__INTSTAT) */
